...
namespace Dilanova_GlazkiSave
{
    ...
    public partial class Dilanova_ГлазкиSaveEntities : DbContext
    {
        private static Dilanova_ГлазкиSaveEntities _context;

        public static Dilanova_ГлазкиSaveEntities GetContext()
        {
            if(_context == null)
